...
![cliamp](https://repo.x-cmd.io/cliamp.svg)
...
Total: **106,295** lines of code across **543** files in the top 5 languages.
...
- **Stars**: 4,096 · **Forks**: 272 · **Open issues**: 196 · **Contributors**: 85

## Totals (cumulative)

- **Releases**: 160 · **Merged PRs**: 188 · **Open PRs**: 28 · **Closed issues**: 127 · **Open issues**: 69 · **Commits**: 901
...
Reported by **7** distros on [repology.org](https://repology.org/project/cliamp). **3** are ✅ on the latest upstream release, **4** are ⚠️ on an older version.
...
_Snapshot: `data/card/260910.yml` · 2026-09-10T23:22:27Z._
