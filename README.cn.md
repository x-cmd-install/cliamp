...
![cliamp](https://repo.x-cmd.io/cliamp.svg?lang=zh)
...
合计: **106,295** 行代码（覆盖前 5 种语言、共 **543** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Go | 104,423 | 8,297 | 11,254 | 512 |
| Html | 995 | 8 | 15 | 1 |
| Svg | 234 | 0 | 0 | 6 |
| Sh | 164 | 9 | 21 | 1 |
| Toml | 156 | 11 | 0 | 23 |
...
- **上游仓库**: <https://github.com/bjarneo/cliamp>
- **官网**: <http://www.cliamp.stream>
- **许可证**: MIT
...
- **Star**: 4,096 · **Fork**: 272 · **开放 issue**: 196 · **贡献者**: 85

## 累计统计

- **发布数**: 160 · **已合并 PR**: 188 · **开放 PR**: 28 · **已关闭 issue**: 127 · **开放 issue**: 69 · **提交数**: 901

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-11 | 9 | 71 | 28 | 19 | 38 | 243 |
| last60d | 2026-07-12 | 16 | 77 | 28 | 26 | 40 | 290 |
| 90d | 2026-06-12 | 17 | 81 | 28 | 33 | 42 | 305 |
| last180d | 2026-03-14 | 100 | 156 | 28 | 93 | 65 | 613 |
| 360d | 2025-09-15 | 100 | 188 | 28 | 127 | 69 | 840 |
| last720d | 2024-09-20 | 100 | 188 | 28 | 127 | 69 | 901 |
...
在 [repology.org](https://repology.org/project/cliamp) 上共有 **7** 个发行版报告此项目。**3** 个 ✅ 已是最新上游版本，**4** 个 ⚠️ 使用旧版本。

| 发行版 | 版本 | 状态 |
|--------|------|------|
| Nix unstable | `2.0.1` | ⚠️ outdated |

## 改进这些数据

cliamp 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `cliamp` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/cliamp.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260910.yml` · 2026-09-10T23:22:27Z._
